...
var creatorList = ['@TierkunGans','@TierKun','@Tier'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'TierKunGanz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'TierKunGanz') return res.json(loghandler.invalidKey)
